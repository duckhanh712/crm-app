...
class About extends Component<any, any> {
  ...
  elementDetail = (title: string, content: any, name: string) => {
    if (title === "Register Time" || title == "Aprroved Time") {
      content = content ? this.handleDate(content) : "---";
    }
    return (
      <React.Fragment>
        {title !== "Description" ? <p>
  ...
  elementSelectBox = (title: string, content: any, name: string) => {
    let clName;
    switch (content) {
      case "INIT": clName = "btn-gradient-success"; break;
      case "APPROVED": clName = "btn-gradient-info"; break
      case "FAIL": clName = "btn-gradient-danger"; break
      ...
      <React.Fragment>
        <p>
          ...
          {shopDetailStore.edit ?
            ...
            :
            <button className={clName} > {content ? content : "null"} </button>
          }
        </p>
      </React.Fragment>
    )
            ...
            <table className="table-about about-product">
              <tr>
                ...
                <th style={{ textAlign: "right" }} >
                  ...
                  <Button type="primary" className="approve-btn-detail" onClick={this.handleApprove} disabled={shopDetailStore.info?.approve_state === "APPROVED"}>
                    {shopDetailStore.info?.approve_state === "APPROVED" ?
                      "Approved"
                      :
                      "Approve Shop"
