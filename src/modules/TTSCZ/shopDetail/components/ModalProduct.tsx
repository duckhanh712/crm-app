          ...
          <React.Fragment>
            ...
            <div className="img-content-product">
              ...
              <div className="content-detail-product">
                ...
                {this.showPrices("Giá", "price", shopDetailStore.currentProduct.prices, shopDetailStore.currentProduct.unit )}
                ...
                {this.showDes("Mô tả ", "description", shopDetailStore.currentProduct?.description)}
